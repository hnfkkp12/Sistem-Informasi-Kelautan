...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center bg-light" href="index.html">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{ asset('img/logoloka.jpg') }}" alt="" class="img-responsive logo float-none !important" width="50vh">
                </div>
            ...
            <!-- Nav Item - Pages Collapse Manajemen Biota -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Manajemen Biota</span>
                </a>
			...
			<!-- Nav Item - Pages Collapse Manajemen User -->
			<li class="nav-item">
			...
			<!-- Nav Item - Pages Collapse Manajemen Kawasan -->
			<li class="nav-item">
                <a class="nav-link" href="{{ url('/sbu') }}">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Manajemen Kawasan</span></a>
			</li>

			<!-- Nav Item - Pages Collapse Manjemen Pelaporan -->
			<li class="nav-item">
                <a class="nav-link" href="{{ url('/perdin') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Managemen Pelaporan</span></a>
			</li>
